...
// Helper method used by DynamicH264VideoEncoder::Encode.
...
bool DynamicH264VideoEncoder::InitOpenH264() {
...
void DynamicH264VideoEncoder::ReleaseOpenH264() {
  if (openh264_handle_ != nullptr) {
...
int32_t DynamicH264VideoEncoder::Release() {
...
int32_t DynamicH264VideoEncoder::RegisterEncodeCompleteCallback(
...
int32_t DynamicH264VideoEncoder::Encode(
...
// in InitializeExt.
SEncParamExt DynamicH264VideoEncoder::CreateEncoderParams(size_t i) const {
...
void DynamicH264VideoEncoder::ReportInit() {
  if (has_reported_init_)
    return;
  RTC_HISTOGRAM_ENUMERATION("WebRTC.Video.DynamicH264VideoEncoder.Event",
                            kH264EncoderEventInit, kH264EncoderEventMax);
  has_reported_init_ = true;
}

void DynamicH264VideoEncoder::ReportError() {
...
VideoEncoder::EncoderInfo DynamicH264VideoEncoder::GetEncoderInfo() const {
  EncoderInfo info;
...
void DynamicH264VideoEncoder::LayerConfig::SetStreamState(bool send_stream) {
