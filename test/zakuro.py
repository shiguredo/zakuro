...
class RpcClient:
    ...
    def get_version(self) -> dict[str, str]:
        """バージョン情報を取得"""
        return self._call("2026.1.0/GetVersion")

    def query(self, sql: str) -> dict[str, Any]:
        """SQL クエリを実行"""
        return self._call("2026.1.0/Query", {"sql": sql})

    def list_connections(self, limit: int = 100) -> dict[str, Any]:
        """接続一覧を取得"""
        return self._call("2026.1.0/ListConnections", {"limit": limit})
...
class Zakuro:
    ...
    使用例:
        ...
        with Zakuro(
            ...
            connections = z.rpc.list_connections()
    ...
    def __init__(
        ...
        self._temp_duckdb_dir: str | None = None
    ...
    def _build_args(self) -> list[str]:
        ...
        # DuckDB 出力用一時ディレクトリを作成
        self._temp_duckdb_dir = tempfile.mkdtemp(prefix="zakuro_duckdb_")
        args.extend(["--duckdb-output-dir", self._temp_duckdb_dir])
            ...
            while time.time() - start_time < self._startup_timeout:
                ...
                try:
                    ...
                    response = client.post(
                        url,
                        json={"jsonrpc": "2.0", "method": "2026.1.0/GetVersion", "id": 1},
                        timeout=5,
                    )
    ...
    def _cleanup(self) -> None:
        ...
        # 一時 DuckDB ディレクトリを削除
        if self._temp_duckdb_dir:
            try:
                shutil.rmtree(self._temp_duckdb_dir, ignore_errors=True)
            except OSError:
                pass
            self._temp_duckdb_dir = None
